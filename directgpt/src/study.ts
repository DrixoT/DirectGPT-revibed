...
const FLOWER_GRADIENT = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="tg" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#ff7a18"/><stop offset="100%" stop-color="#ffb300"/></linearGradient></defs><circle cx="150" cy="60" r="22" fill="url(#tg)"/><circle cx="176" cy="79" r="22" fill="url(#tg)"/><circle cx="166" cy="110" r="22" fill="url(#tg)"/><circle cx="134" cy="110" r="22" fill="#ff7a18"/><circle cx="124" cy="79" r="22" fill="#ff7a18"/><circle cx="150" cy="88" r="13" fill="#faf8f5"/></svg>`;

const FLOWER_ADD = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="60" r="22" fill="#ff7a18"/><circle cx="176" cy="79" r="22" fill="#ff7a18"/><circle cx="166" cy="110" r="22" fill="#ff7a18"/><circle cx="134" cy="110" r="22" fill="#ff7a18"/><circle cx="124" cy="79" r="22" fill="#ff7a18"/><circle cx="150" cy="88" r="13" fill="#faf8f5"/><line x1="150" y1="120" x2="150" y2="190" stroke="#0d0700" stroke-width="5"/><line x1="150" y1="175" x2="105" y2="140" stroke="#0d0700" stroke-width="5"/><line x1="150" y1="175" x2="195" y2="140" stroke="#0d0700" stroke-width="5"/><circle cx="103" cy="138" r="12" fill="#0d0700"/><circle cx="197" cy="138" r="12" fill="#0d0700"/></svg>`;

const FLOWER_REMOVE = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="60" r="22" fill="#ff7a18"/><circle cx="176" cy="79" r="22" fill="#ff7a18"/><circle cx="150" cy="88" r="13" fill="#faf8f5"/></svg>`;

const FLOWER_FLIP = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,200) scale(1,-1)"><circle cx="150" cy="60" r="22" fill="#ff7a18"/><circle cx="176" cy="79" r="22" fill="#ff7a18"/><circle cx="166" cy="110" r="22" fill="#ff7a18"/><circle cx="134" cy="110" r="22" fill="#ff7a18"/><circle cx="124" cy="79" r="22" fill="#ff7a18"/><circle cx="150" cy="88" r="13" fill="#faf8f5"/></g></svg>`;

const SMILEY_GRADIENT = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="tg" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#ff7a18"/><stop offset="100%" stop-color="#ffb300"/></linearGradient></defs><circle cx="150" cy="80" r="45" fill="url(#tg)"/><circle cx="135" cy="68" r="5" fill="#0d0700"/><circle cx="165" cy="68" r="5" fill="#0d0700"/><circle cx="150" cy="84" r="4" fill="#0d0700"/><line x1="130" y1="102" x2="170" y2="102" stroke="#0d0700" stroke-width="3"/></svg>`;

const SMILEY_ADD = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="80" r="45" fill="#ff7a18"/><circle cx="135" cy="68" r="5" fill="#0d0700"/><circle cx="165" cy="68" r="5" fill="#0d0700"/><circle cx="150" cy="84" r="4" fill="#0d0700"/><line x1="130" y1="102" x2="170" y2="102" stroke="#0d0700" stroke-width="3"/><line x1="150" y1="125" x2="150" y2="180" stroke="#0d0700" stroke-width="3"/><line x1="150" y1="140" x2="110" y2="162" stroke="#0d0700" stroke-width="3"/><line x1="150" y1="140" x2="190" y2="162" stroke="#0d0700" stroke-width="3"/><circle cx="108" cy="163" r="7" fill="#0d0700"/><circle cx="192" cy="163" r="7" fill="#0d0700"/></svg>`;

const SMILEY_REMOVE = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="80" r="45" fill="#ff7a18"/><circle cx="135" cy="68" r="5" fill="#0d0700"/><circle cx="165" cy="68" r="5" fill="#0d0700"/></svg>`;

const SMILEY_FLIP = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><g transform="translate(0,200) scale(1,-1)"><circle cx="150" cy="80" r="45" fill="#ff7a18"/><circle cx="135" cy="68" r="5" fill="#0d0700"/><circle cx="165" cy="68" r="5" fill="#0d0700"/><circle cx="150" cy="84" r="4" fill="#0d0700"/><line x1="130" y1="102" x2="170" y2="102" stroke="#0d0700" stroke-width="3"/></g></svg>`;
